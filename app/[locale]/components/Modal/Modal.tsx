  ...
  return (
    <>
      <div
        ref={modalRef}
        className={
          `fixed z-13 w-[98vw] md:w-[70vw] max-h-[80vh] p-5 flex flex-col gap-5 bg-main
           rounded-xl left-1/2 top-1/2 transform -translate-1/2 overflow-scroll  translate-y-[500vw] 
